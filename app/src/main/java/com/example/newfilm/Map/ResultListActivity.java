...
public class ResultListActivity extends ListActivity {
    ...
    public ResultListener<Place> m_placeResultListener = new ResultListener<Place>() {
        @Override
...
//                intent.putExtra("la1t",geoCoordinate.getLatitude() +"");
//                intent.putExtra("la2t",geoCoordinate.getLongitude() +"");
