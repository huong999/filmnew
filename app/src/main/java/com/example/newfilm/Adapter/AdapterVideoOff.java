...
import com.example.newfilm.Activity.PlayOff;
import com.example.newfilm.Model.ModelVideo;
import com.example.newfilm.R;

import java.util.ArrayList;

public class AdapterVideoOff extends RecyclerView.Adapter<AdapterVideoOff.MyViewHolder> {

    ArrayList<ModelVideo> videosList = new ArrayList<ModelVideo>();
    Context context;

    public AdapterVideoOff(Context context, ArrayList<ModelVideo> videosList){
    ...
    @NonNull
    @Override
    public AdapterVideoOff.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_video, parent, false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterVideoOff.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), PlayOff.class);
                intent.putExtra("videoIda", item.getId());
                intent.putExtra("ttvideo", item.getTitle());
